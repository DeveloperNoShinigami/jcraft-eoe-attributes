...
public class SplatterEffectRenderer {
    ...
    private static void renderSection(SplatterSection section, BufferBuilder buf, PoseStack matrices, float alpha, float offset) {
        ...
        int blockLight = section.getWorld().getLightLevel(LightLayer.BLOCK, section.getBlockPos());
        int skyLight = section.getWorld().getLightLevel(LightLayer.SKY, section.getBlockPos());

...
public interface JItemRegistry {
    ...
    RegistrySupplier<Item> DISC_WONDER_OF_YOU = register("disc_wonder_of_you", () -> new RecordItem(1, JSoundRegistry.WONDER_OF_YOU.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 24));
    RegistrySupplier<Item> DISC_HALLELUJAH_CHORUS = register("disc_hallelujah_chorus", () -> new RecordItem(1, JSoundRegistry.HALLELUJAH_CHORUS.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 207));
    ...
    RegistrySupplier<Item> DISC_SONO_CHI_NO_SADAME = register("disc_sono_chi_no_sadame", () -> new RecordItem(1, JSoundRegistry.SONO_CHI_NO_SADAME.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 86));
    RegistrySupplier<Item> DISC_BLOODY_STREAM = register("disc_bloody_stream", () -> new RecordItem(1, JSoundRegistry.BLOODY_STREAM.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 93));
    RegistrySupplier<Item> DISC_END_OF_THE_WORLD = register("disc_end_of_the_world", () -> new RecordItem(1, JSoundRegistry.END_OF_THE_WORLD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 84));
    RegistrySupplier<Item> DISC_CRAZY_NOISY_BIZARRE_TOWN = register("disc_crazy_noisy_bizarre_town", () -> new RecordItem(1, JSoundRegistry.CRAZY_NOISY_BIZARRE_TOWN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 181));
    ...
    RegistrySupplier<Item> DISC_GREAT_DAYS = register("disc_great_days", () -> new RecordItem(1, JSoundRegistry.GREAT_DAYS.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 240));

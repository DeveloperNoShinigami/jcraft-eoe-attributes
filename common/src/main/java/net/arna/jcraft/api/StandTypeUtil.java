...
public class StandTypeUtil {
     ...
     */
    public static boolean isNone(StandType2 type) {
     ...
     */
    public static Stream<StandType2> streamAll() {
     ...
     */
    public static Stream<StandType2> streamAllObtainable() {
     ...
     */
    public static StandType2 getRandomRegular() {
        List<StandType2> types = streamAllObtainable()
     ...
     */
    public static StandType2 getRandom() {
        List<StandType2> types = streamAllObtainable().toList();
        return types.get(new Random().nextInt(types.size()));
    }
}

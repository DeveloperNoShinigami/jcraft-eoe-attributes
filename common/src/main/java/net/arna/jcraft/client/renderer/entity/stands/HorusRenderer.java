...
public class HorusRenderer extends StandEntityRenderer<HorusEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, HorusEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {

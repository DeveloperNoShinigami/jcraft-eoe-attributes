...
public class GERScorpionModel extends GeoModel<GERScorpionEntity> {
    @Override
    public ResourceLocation getModelResource(GERScorpionEntity object) {
        return JCraft.id("geo/gerscorpion.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GERScorpionEntity object) {
        return object.isRock() ? JCraft.id("textures/entity/rock.png") : JCraft.id("textures/entity/gerscorpion.png");
    }

    @Override
    public ResourceLocation getAnimationResource(GERScorpionEntity animatable) {

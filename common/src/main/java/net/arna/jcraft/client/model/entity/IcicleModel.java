...
public class IcicleModel extends GeoModel<IcicleProjectile> {
    @Override
    public ResourceLocation getModelResource(IcicleProjectile object) {
        return JCraft.id("geo/icicle.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(IcicleProjectile object) {
        return JCraft.id("textures/entity/projectiles/icicle.png");
    }

    @Override
    public ResourceLocation getAnimationResource(IcicleProjectile animatable) {

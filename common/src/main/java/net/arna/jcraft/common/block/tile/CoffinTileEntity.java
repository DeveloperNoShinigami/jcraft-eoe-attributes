...
public class CoffinTileEntity extends BlockEntity {
    ...
    public static final AzCommand OPEN = AzCommand.create(BASE_CONTROLLER, "animation.coffin.open", AzPlayBehaviors.LOOP);
    public static final AzCommand CLOSE = AzCommand.create(BASE_CONTROLLER, "animation.coffin.closed", AzPlayBehaviors.LOOP);

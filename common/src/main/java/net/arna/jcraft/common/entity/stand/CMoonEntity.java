...
public class CMoonEntity extends StandEntity<CMoonEntity, CMoonEntity.State> {
    ...
    public static final LaunchAttack LAUNCH = new LaunchAttack(60, 14, 21, 0.75f,
    ...
    public static final CGroundSlamAttack GROUND_SLAM = new CGroundSlamAttack(18, 10, 18,

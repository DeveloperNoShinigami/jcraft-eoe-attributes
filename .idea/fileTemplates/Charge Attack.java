...
public class ${NAME} extends AbstractChargeAttack<${NAME}, ${ATTACKER}, ${ATTACKER}.State> {
    public ${NAME}(final int cooldown, final int windup, final int duration, final float moveDistance,
        ...
        super(cooldown, windup, duration, moveDistance, damage, stun, hitboxSize, knockback, offset, ${ATTACKER}.State.CHARGE_HIT);
    }
    ...
    public static final class Type extends AbstractChargeAttack.Type<${NAME}> {

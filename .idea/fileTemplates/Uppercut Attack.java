...
public class ${NAME} extends AbstractUppercutAttack<${NAME}, ${ATTACKER}> {
    public ${NAME}(final int cooldown, final int windup, final int duration, final float moveDistance,
                   ...
                   final float offset, final float strength) {

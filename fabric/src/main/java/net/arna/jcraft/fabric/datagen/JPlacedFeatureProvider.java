...
public class JPlacedFeatureProvider {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        context.register(JPlacedFeatureRegistry.SAND_DISK,
                new PlacedFeature(sandDiskCf, OrePlacedFeatures.modifiersWithCount(1, HeightRangePlacementModifier.uniform(YOffset.fixed(32), YOffset.fixed(96)))));
    }
